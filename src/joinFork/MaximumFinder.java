...
/**
 * Created by vasanthakumarsubramanian on 12/26/16.
 */
...
//        System.out.println(Thread.currentThread() + " computing: " + start + " to " + end);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Elapsed time for fast find = " + (fast.elapsedTime()));
        ...
        System.out.println("max by direct method = " + max);
        System.out.println("Elapsed time for direct find = " + direct.elapsedTime());
